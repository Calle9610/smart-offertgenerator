...
from app.models import Company, User, ProjectRequirements, GenerationRule, Quote, QuoteItem, Tenant
...
class TestCRUDCompanyIdScoping:
    ...
    def test_get_generation_rule_by_key(self, db_session: Session):
        ...
        found_rule = get_generation_rule_by_key(db_session, "bathroom|standard", company.id)
