...
def upgrade() -> None:
    ...
    op.create_table('price_profile',
        ...
        sa.Column('vat_rate', sa.Numeric(precision=5, scale=2), nullable=False, default=25.00),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('material',
        ...
        sa.Column('markup_pct', sa.Numeric(precision=6, scale=2), nullable=False, default=20.00),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['company_id'], ['company.id']),
        sa.ForeignKeyConstraint(['profile_id'], ['price_profile.id'])
    )
